...
public class OldBackgroundService extends Service {
    ...
    public void onDestroy() {
        ...
        getApplicationContext().startService(new Intent(getApplicationContext(), OldBackgroundService.class));
    }
