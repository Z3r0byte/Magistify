...
public class AppointmentDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMagister = GlobalAccount.MAGISTER;
        ...
        if (extras != null) {
            ...
            Toast.makeText(AppointmentDetailsActivity.this, R.string.err_unknown, Toast.LENGTH_SHORT).show();
            finish();
        }
                ...
                public void run() {
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(AppointmentDetailsActivity.this, R.string.msg_deleted, Toast.LENGTH_SHORT).show();
                            }
                        });
                        SharedListener.finishInitiator.finished();
                        finish();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(AppointmentDetailsActivity.this, R.string.err_no_connection, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
